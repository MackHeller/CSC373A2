...
public class RandomMST {
    //used to add up total weight of MST
    public double totalWeight;
    //used to keep track of the current larges edge for optimisation.
    ...
    /**
     * Kruskal algorithm, takes a sorted list of edges and builds an MST. Exists early
     * once the MST is completed.
     * @param edgeIterator an iterator over a set of sorted by weight edges
